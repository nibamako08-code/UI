...
if GameId == 1720936166 then
    ...
    loadstring(game:HttpGet("https://wareguardv2.xyz/raw_anyhub?hub=starhub&script=WLVN", true))()

elseif GameId == 5130394318 then
    -- 2. Bizarre Lineage
    NotifyLoad("Bizarre Lineage")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nibamako08-code/ILUVU/refs/heads/main/BizarreLineageVN.lua", true))()

elseif PlaceId == 286090429 then
    -- 3. Arsenal
    NotifyLoad("Arsenal")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nibamako08-code/ILUVU/refs/heads/main/AVN.lua", true))()
...
elseif PlaceId == 70845479499574 or PlaceId == 11520107397 or PlaceId == 11520108331 then
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nibamako08-code/ILUVU/refs/heads/main/BBNVN.lua", true))()

elseif PlaceId == 9391468976 then
    -- 5. Jujutsu Shenanigans
    NotifyLoad("Jujutsu Shenanigans")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nibamako08-code/ILUVU/refs/heads/main/JJSVN.lua", true))()

elseif GameId == 4658598196 then
    -- 6. attack on titan revolution
    NotifyLoad("attack on titan revolution")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nibamako08-code/ILUVU/refs/heads/main/AOTRVN.lua", true))()
